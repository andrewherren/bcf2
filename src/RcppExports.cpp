...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bcf2_bcfoverparRcppClean_ini", (DL_FUNC) &_bcf2_bcfoverparRcppClean_ini, 46},
    {NULL, NULL, 0}
};
